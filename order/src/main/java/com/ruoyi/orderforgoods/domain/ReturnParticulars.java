 ...
 * @date 2023-12-28
 */
public class ReturnParticulars extends BaseEntity
{
    ...
    public ReturnParticulars() {
    }

    public ReturnParticulars(long serialVersionUID, Long mId, String rdNumber, Date time, Integer judge, String sId, String fruitId, BigDecimal rdCount) {
