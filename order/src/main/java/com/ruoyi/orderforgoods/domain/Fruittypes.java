...
public class Fruittypes extends BaseEntity
{
    ...
    public Fruittypes(long serialVersionUID, Long fruittypesId, String name, String code, String createdBy, Date createdTime, String updatedBy, Date updatedTime, Long REVISION, Long isStatus) {
