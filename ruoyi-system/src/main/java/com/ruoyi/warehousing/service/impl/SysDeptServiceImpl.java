...
import com.ruoyi.warehousing.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    @Override
    public Integer selectID(Long parentId, String deptName, String ancestors) {
        Integer i = deptMapper.selectID(parentId, deptName, ancestors);

        return i;
    }

    @Override
    public Integer insertshop(String snumber, String sname) {
        Integer insertshop = deptMapper.insertshop(snumber, sname);
        return insertshop;
    }

    @Override
    public Integer insertCK(String wnumber, String wname) {
        Integer i = deptMapper.insertCK(wnumber, wname);
        return i;
    }
}
