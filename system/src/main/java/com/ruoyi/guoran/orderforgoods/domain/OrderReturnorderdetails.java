 ...
 * @date 2023-12-28
 */
public class OrderReturnorderdetails extends BaseEntity
{
    ...
    public OrderReturnorderdetails() {
    }

    public OrderReturnorderdetails(long serialVersionUID, Long rdId, String sId, Long warehousingId, String rdNumber, String fruittypesId, String fruitId, BigDecimal rdCount, Long REVISION, String createdBy, Date createdTime, String updatedBy, Date updatedTime, Long isStatus, Integer examine) {
