 ...
 */
@Getter
public class OrderReturnStatistics extends BaseEntity
{
   ...
   private String sId;
    ...
    public OrderReturnStatistics() {
    }

    public OrderReturnStatistics(long serialVersionUID, Long id, String sId, String fruitId, BigDecimal rdCount, Date returnTime, Integer isStatus, String warehouseId) {
