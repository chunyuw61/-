 ...
 * @date 2023-12-28
 */
public class OrderSalesStatistics extends BaseEntity
{
 ...
 */
    ...
    public OrderSalesStatistics() {
    }

    public OrderSalesStatistics(long serialVersionUID, Long salesStatisticId, Long oId, String sId, Date date, BigDecimal turnover, Integer passengerFlow, BigDecimal avgSales, Long revision, Long isStatus, String createdBy, Date createdTime) {
