 ...
 * @date 2023-12-26
 */
public class OrderFruits extends BaseEntity
{
    ...
    public OrderFruits(long serialVersionUID, Long fruitId, String fruittypesId, String code, String name, String img, Long REVISION, String createdBy, Date createdTime, String updatedBy, Date updatedTime, Long isStatus) {
