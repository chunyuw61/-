...
public class Returnorderdetails extends BaseEntity
{
    ...
    public Returnorderdetails(long serialVersionUID, Long rdId, String sId, Long warehousingId, String rdNumber, String fruittypesId, String fruitId, Double rdCount, Long REVISION, String createdBy, Date createdTime, String updatedBy, Date updatedTime, Long isStatus, Integer examine) {
