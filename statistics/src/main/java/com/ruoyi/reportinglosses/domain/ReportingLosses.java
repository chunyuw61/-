package com.ruoyi.reportinglosses.domain;
...
public class ReportingLosses extends BaseEntity
{
    ...
    public ReportingLosses(String sId, String oId, Date datetime, String fruitsId, BigDecimal number, BigDecimal unitPrice, String totalPrice, String cause) {
        this.sId = sId;
        this.oId = oId;
