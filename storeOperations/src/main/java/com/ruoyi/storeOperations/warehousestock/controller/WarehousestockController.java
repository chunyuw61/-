package com.ruoyi.storeOperations.warehousestock.controller;
...
public class WarehousestockController extends BaseController
{
    ...
    public int addOthers(Long id , Double input, String value){
        ...
        String s = warehousestockMapper.selectShopByRen(sysUser.getUserName());
        ...
        Warehousestock warehousestock = warehousestockMapper.selectWarehousestockByWhId(id);
        System.out.println(warehousestock);

        int i = purchaseorderdetailsMapper.insertPurchaseorderdetails(new Purchaseorderdetails(
                null,
                s,
                value,
