package com.ruoyi.storeOperations.purchaseorderdetails.controller;
...
public class PurchaseorderdetailsController extends BaseController {
    ...
    @Autowired
    private WarehousestockMapper warehousingMapper;
    ...
    public int confirm(Long pId) {
        ...
        Purchaseorderdetails purchaseorderdetails = purchaseorderdetailsMapper.selectPurchaseorderdetailsByPId(pId);
        ...
        int i = purchaseorderdetailsMapper.updateStatus(pId);
    ...
    public boolean back(Long pId , Double returnNum) {
        ...
        int i = returnorderdetailsMapper.insertReturnorderdetails(new Returnorderdetails(
                null,
